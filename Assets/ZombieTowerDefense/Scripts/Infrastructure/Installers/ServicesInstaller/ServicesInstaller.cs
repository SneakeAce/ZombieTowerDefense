...
public class ServicesInstaller : MonoInstaller
{
    ...
    {
        Container.Bind<IPoolsFactoryAsync>()
            .To<PoolsFactory<PlayerUnit, PlayerUnitConfig, PlayerPoolStats, PlayerUnitsPoolsConfig, PlayerUnitType>>()
            .AsSingle();   
        
        Container.Bind<IPoolsFactoryAsync>()
            .To<PoolsFactory<EnemyUnit, EnemyUnitConfig, EnemyPoolStats, EnemyUnitsPoolsConfig, EnemyUnitType>>()
            .AsSingle();
